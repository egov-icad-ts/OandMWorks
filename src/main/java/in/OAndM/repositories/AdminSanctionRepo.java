...
public AdminSanctionsEntity findByworkIdAndIsLatestAndDeleteFlagAndTechnEntriesIsLatestTrueAndTechnEntriesDeleteFlagFalse(Integer workId,Boolean isLatest,Boolean deleteFlag);
